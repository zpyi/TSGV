    ...
    def predict_loop(
        ...
        with torch.no_grad():
            ...
            for data in eval_dataloader:
                # convert to dict.
                index = {}
                index={"idx":data["idx"], "text_description":data["text_description"]}
                ...
                text_descriptions.append(index["text_description"]) # 256 original text descriptions
                data = self.to_ctx(data)
            ...
            import pdb
            pdb.set_trace()
            with open('text_descriptions.txt', 'w') as f:
                for ind, te in  enumerate(text_descriptions):
                    f.write(ind + " " + te)
